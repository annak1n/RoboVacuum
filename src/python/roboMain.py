...
class Robot(object):
    ...
    def __init__(self):
        ...
        self.clickPerRotation = 1.0/1024.0
    ...
    def decodeSpeeds(self, dt):
        ...
        # print(self.clicks)
        self.wheelSpeeds = self.clicks*self.clickPerRotation * \
            self.wheelCircumference*self.MCfrequency
    ...
    def setSpeedAngle(self, a):
        ...
        while self.sema == True:  # the sema allows the threads to be closed by another process
            ...
            # get gyroscope angle
            self.RealAngle = pi*self.bno.read_euler()[0]/180
